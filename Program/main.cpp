                    ...
                    for (auto &book : pendingRequests)
                    {
                         if (book.getSerialNumber() == serialNumber)
                         {
                              ...
                              if (approvalChoice == 'A' || approvalChoice == 'a')
                              {
                                   ...
                                   ofstream bookFile("../txt file/approvedBooks.txt", ios::app);
                                   if (bookFile.is_open())
                                   {
                                        bookFile << "Book Name: " << book.getBookName() << endl;
                                        bookFile << "Author Name: " << book.getAuthorName() << endl;
                                        bookFile << "Serial Number: " << book.getSerialNumber() << endl;
                                        bookFile << "----------------------------" << endl;
                                        bookFile.close();
